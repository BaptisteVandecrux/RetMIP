...
plot_diff_therm <- function(i_site_in) {
  ...
  pList <- lapply(1:length(models), function(i_mod){
    p <- ggplot(data = df,
        ...
        scale_fill_gradientn(name="Modelled - observed firn temperature (K)",
