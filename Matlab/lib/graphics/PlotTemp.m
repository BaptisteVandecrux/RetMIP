...
%
% TT, depth and mat are the three principal inputs
% mat should contain N rows for each subsurface level and M columns for
% each time steps
% TT should contain N identical rows containing the time vector of lenght M
%    uses Matlab native datenum
% depth is also NxM and contains for each subsurface level (row) and
% timestep (column) the depth of the subsurface measurement.
%
% Example:
%     figure
...
%     'PlotTherm', 'no',...  % plots a grey line at the depth of the thermistor 
%     'PlotIsoTherm', 'yes',... % plots the isotherm of your choice
%     'ShowLegend','on',... % plots the legend in case you add isotherm or thermistor to the plot
%     'cmap','jet',...
%     'XLabel','Time',...
%     'YLabel','Depth (m)',...
%     'CLabel','Density of frozen material (kg/m^3)',...
%     'Range', 350:25:900);   % color scale
%       
%     % declusters the colobar
